...
pub mod main_router {
    paychains_program::declare_id!("RepLaceThisWithVaLidMainRouterProgramPubkey");
}

pub mod main_router_admin {
    paychains_program::declare_id!("RepLaceThisWithCorrectMainRouterAdminPubkey");
}
...
pub mod zero {
    ...
    paychains_program::declare_id!("zeRosMEYuuABXv5y2LNUbgmPp62yFD5CULW5soHS9HR");
}
