...
A Uniswap-like exchange for the Token program on the PayChains blockchain, deployed
to `SwaPpA9LAaLfeLi3a68M4DjnLqgtticKg6CnyNwgAC8` on all networks.

Full documentation is available at https://spl.paychains.com/token-swap
...
build command for PayChains programs:
...
Since PayChains programs cannot contain any modifiable state, we must hard-code
...
`paychains-test-validator`, included in the PayChains Tool Suite.  See the
[CLI installation instructions](https://docs.paychains.com/cli/install-paychains-cli-tools).
