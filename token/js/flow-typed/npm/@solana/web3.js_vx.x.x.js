...
// flow-typed version: <<STUB>>/@paychains/web3.js_v0.0.0-development/flow_v0.145.0
...
declare module '@paychains/web3.js' {
  /**
  ...
  /**
   * Epoch schedule
   * (see https://docs.paychains.com/terminology#epoch)
   */
...
*/
  ...
  declare export type StakeAuthorizationType = {
    /**
     * The Stake Authorization index (from paychains-stake-program)
     */
    index: number,
    ...
  };
  ...
  declare export class StakeProgram {
     ...
     *
     * This is generated from the paychains-stake-program StakeState struct as
     * `std::mem::size_of::<StakeState>()`:
     * https://docs.rs/paychains-stake-program/1.4.4/paychains_stake_program/stake_state/enum.StakeState.html
     */
    static space: number;
   ...
   */
  declare export var LAMPORTS_PER_PAY: any; // 1000000000
}
 ...
 * needed.
 */
declare module '@paychains/web3.js/commitlint.config' {
  declare module.exports: any;
}

declare module '@paychains/web3.js/lib/index.browser.esm' {
  declare module.exports: any;
}

declare module '@paychains/web3.js/lib/index.cjs' {
  declare module.exports: any;
}

declare module '@paychains/web3.js/lib/index.esm' {
  declare module.exports: any;
}

declare module '@paychains/web3.js/lib/index.iife' {
  declare module.exports: any;
}

declare module '@paychains/web3.js/lib/index.iife.min' {
  declare module.exports: any;
}

declare module '@paychains/web3.js/module.flow' {
  declare module.exports: any;
}

declare module '@paychains/web3.js/rollup.config' {
  declare module.exports: any;
}

declare module '@paychains/web3.js/rollup.config.types' {
  declare module.exports: any;
}

declare module '@paychains/web3.js/test/rollup.config' {
  declare module.exports: any;
}

// Filename aliases
declare module '@paychains/web3.js/commitlint.config.js' {
  declare module.exports: $Exports<'@paychains/web3.js/commitlint.config'>;
}
declare module '@paychains/web3.js/lib/index.browser.esm.js' {
  declare module.exports: $Exports<'@paychains/web3.js/lib/index.browser.esm'>;
}
declare module '@paychains/web3.js/lib/index.cjs.js' {
  declare module.exports: $Exports<'@paychains/web3.js/lib/index.cjs'>;
}
declare module '@paychains/web3.js/lib/index.esm.js' {
  declare module.exports: $Exports<'@paychains/web3.js/lib/index.esm'>;
}
declare module '@paychains/web3.js/lib/index.iife.js' {
  declare module.exports: $Exports<'@paychains/web3.js/lib/index.iife'>;
}
declare module '@paychains/web3.js/lib/index.iife.min.js' {
  declare module.exports: $Exports<'@paychains/web3.js/lib/index.iife.min'>;
}
declare module '@paychains/web3.js/module.flow.js' {
  declare module.exports: $Exports<'@paychains/web3.js/module.flow'>;
}
declare module '@paychains/web3.js/rollup.config.js' {
  declare module.exports: $Exports<'@paychains/web3.js/rollup.config'>;
}
declare module '@paychains/web3.js/rollup.config.types.js' {
  declare module.exports: $Exports<'@paychains/web3.js/rollup.config.types'>;
}
declare module '@paychains/web3.js/test/rollup.config.js' {
  declare module.exports: $Exports<'@paychains/web3.js/test/rollup.config'>;
}
